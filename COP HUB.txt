...
game.StarterGui:SetCore("SendNotification", {
  Title = "COP HUB"; -- the title (ofc)
  Text = text; -- what the text says (ofc)
  Icon = "rbxassetid://84264500316934"; -- the image if u want.
...
Shop:Button("Random Race (Use 3K Fragments)", function()
    ...
    Misc:Button("Destroy Ui",function()
        if game.CoreGui:FindFirstChild("COP HUB") then
            game.CoreGui:FindFirstChild("COP HUB"):Destroy()
            game.CoreGui:FindFirstChild("MESSI"):Destroy()
        end
    end)
